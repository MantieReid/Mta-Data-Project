...
# Create a line chart for each station and save it as an image file. 
# Then, embed the image in an Excel sheet. Each station will have its own tab in the Excel file. The time will be in AM/PM format.
